...
jwm::Theme jwm::ThemeHelperWin32::setTheme(jwm::Theme theme)
{
  ...
  bool isDarkMode = (theme == jwm::Theme::Dark) ? _isDarkModeSupported() : false;
...
bool jwm::ThemeHelperWin32::_setThemeInternal(HWND hWnd, Theme theme, bool isDarkMode)
{
  ...
  fn = (jwm::SetWindowCompositionAttribute)GetProcAddress(hMod, "SetWindowCompositionAttribute");
  if (!fn)
  {
    JWM_VERBOSE("Failed to get proc address for SetWindowCompositionAttribute function");
    FreeLibrary(hMod);
    return false;
  }
