...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_jwm_impl_RefCounted__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&jwm::unrefRefCounted));
}

extern "C" JNIEXPORT jint JNICALL Java_org_jetbrains_jwm_impl_RefCounted_getRefCount
